...
class Artist(AbstractUser):
    ...
    def save(self, **kwargs):
        ...
        # self.username = hashlib.sha256(self.username.encode()).hexdigest()
        self.ip_address = hashlib.sha256(self.ip_address.encode()).hexdigest()
        self.mail = hashlib.sha256(self.mail.encode()).hexdigest()
...
class Art(models.Model):
    ...
    art_owner = models.ForeignKey(Artist, on_delete=models.DO_NOTHING)
